...
public class StudentRepositoryTest {
    ...
    @Autowired
    private StudentRepository studentRepositoryMyBatis;
    ...
    void shouldSaveAndLoadCorrectStudent() {
        ...
        Assertions.assertThat(actualStudent).isNotNull().isEqualToComparingOnlyGivenFields(expectedStudent, FIELD_NAME);
    }
    ...
    void shouldUpdateStudentName() {
        ...
        Assertions.assertThat(actualStudent).isNotNull().hasFieldOrPropertyWithValue(FIELD_NAME, student.getName());
    }
    ...
    void shouldDeleteStudentFromDbById() {
        ...
        Assertions.assertThat(studentsCountBefore - studentsCountAfter).isEqualTo(1);
    }
